...
<body>
	<div class="div">
				...
				<div class="topic-meta row">
					<div class="col-xs-2 col-sm-1">
						<img class="user-avatar"
							src="http://www.gravatar.com/avatar/4e5750bb485db473fc5fcaac227b78e3?d=&amp;s=48"
							alt="" />
					</div>
					<div class="col-xs-9 col-sm-10">
						<p class="text-muted">
							<a href="/u/1/" id="noteUser"></a> <br /> <span><font
								id="noteAddTime"></font>&nbsp;<a class="text-primary"
								id="sectionName"></a>, </span> <span>查看: <a id="replayTatol"></a>
								次
							</span>
						</p>
					</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading">100回复数</div>
			<!-- List group -->
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div id="tishi" class="alert alert-warning" role="alert">
					请先<a href="#">登录</a> 或者 <a href="/BBS/test/regist.jsp">注册新账号</a>
					然后回复
				</div>
			...
			<div class="panel-body">
				<form method="post">
					<input type='hidden' name='csrfmiddlewaretoken'
						value='VqI90nTviLspVtJlQkKeGxomBnfTRPcR' />
							...
							<div class="wmd-wrapper" id="id_content_raw-wmd-wrapper">
								<div class="wmd-panel">
									...
									<textarea class="pagedownwidget form-control wmd-input"
										cols="40" id="replayContent" name="content_raw" rows="10"></textarea>
								</div>
					...
					<div class="form-group">
						<div class="controls ">
							<input type="button" name="submit" value="回复"
								class="btn btn-primary" id="sendReplay" />
						</div>
					</div>
				</form>
			</div>
